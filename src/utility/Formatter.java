...
public class Formatter {
    ...
    /**
     * Format a source code directly Copy content of original source, then store
     * the copy into the same path with the original source
     *
...
//		frmJudge parent = new frmJudge();
     ...
     */
    public static boolean checkFormat(String fileName, String type, frmJudge parent) {
        try {
